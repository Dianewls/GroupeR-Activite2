...
public class TestGrilleImpl {
     ...
     */
    private final char[][] grille9x9ARemplir = {
            {'@', '6', '@', '@', '4', '5', '3', '7', '@'},
            {'@', '@', '5', '6', '7', '3', '4', '2', '@'},
            {'@', '@', '4', '@', '@', '@', '@', '@', '1'},
            {'5', '@', '@', '7', '@', '2', '@', '@', '4'},
     ...
     */
    private final char[][] grille9x9Remplie = {
            {'9', '6', '2', '1', '4', '5', '3', '7', '8'},
            {'1', '8', '5', '6', '7', '3', '4', '2', '9'},
            {'3', '7', '4', '2', '9', '8', '5', '6', '1'},
            {'5', '3', '1', '7', '6', '2', '9', '8', '4'},
     ...
     */
    private final char[][] grille16x16ARemplir = {
            {'@', '2', '@', '@', '8', '@', 'B', '@',
             '@', '@', '@', '@', '@', '@', '5', '7'},
            {'9', 'F', 'C', '@', '@', '1', '@', '@',
             '@', '8', '5', 'B', 'E', '4', 'A', '2'},
     ...
     */
    private final char[][] grille16x16Remplie = {
            {'E', '2', '4', '6', '8', '3', 'B', 'F',
             'A', '1', '9', 'G', 'D', 'C', '5', '7'},
            {'9', 'F', 'C', '3', 'G', '1', '6', '7',
             'D', '8', '5', 'B', 'E', '4', 'A', '2'},
    ...
    /**
     * methode qui teste Possible().
     * pour voir si le caractere est autorise.
     */
      @Test
