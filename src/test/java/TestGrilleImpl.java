...
public class TestGrilleImpl {
    ...
    private char[][] grille16x16Remplie1 = {
            { 'C', '8', '7', '9', '6', 'B', 'A', '3', 'G', '4', 'E', '5', 'F', '1', 'D', '2' },
            { 'B', '2', 'F', 'D', '1', '5', '9', 'G', '7', '3', '8', 'C', '6', '4', 'E', 'A' },
            { '5', 'E', '4', '3', 'D', 'F', '2', '8', '1', '6', 'A', '9', '7', 'G', 'C', 'B' },
            { '6', '1', 'G', 'A', 'E', '7', 'C', '4', 'F', 'D', '2', 'B', '9', '5', '8', '3' },
            { 'A', '9', 'D', 'C', '4', '6', '8', '7', '3', '1', 'G', 'E', 'B', '2', 'F', '5' },
            { 'G', 'F', '5', '8', '3', '1', 'D', 'A', '4', '2', 'B', '7', 'E', 'C', '6', '9' },
            { '4', '6', 'B', '1', '2', '9', 'E', 'F', 'A', '5', 'C', '8', '3', 'D', '7', 'G' },
            { '3', '7', '2', 'E', 'G', 'C', '5', 'B', '9', 'F', '6', 'D', '1', 'A', '4', '8' },
            { 'F', 'C', '8', '7', '9', 'A', '1', 'D', 'B', 'G', '5', '3', '4', 'E', '2', '6' },
            { 'E', 'D', 'A', 'G', '8', '4', '6', '2', 'C', '9', '7', '1', '5', 'B', '3', 'F' },
            { '1', 'B', '6', '2', 'F', 'G', '3', '5', '8', 'E', 'D', '4', 'C', '9', 'A', '7' },
            { '9', '4', '3', '5', 'B', 'E', '7', 'C', '2', 'A', 'F', '6', 'D', '8', 'G', '1' },
            { '7', '3', 'C', '6', 'A', 'D', 'B', '1', 'E', '8', '9', 'G', '2', 'F', '5', '4' },
            { 'D', 'A', '9', 'B', '5', '8', 'F', 'E', '6', '7', '4', '2', 'G', '3', '1', 'C' },
            { '2', 'G', 'E', 'F', '7', '3', '4', '9', '5', 'C', '1', 'A', '8', '6', 'B', 'D' },
            { '8', '5', '1', '4', 'C', '2', 'G', '6', 'D', 'B', '3', 'F', 'A', '7', '9', 'E' } };
    
    /**
     * Grille7x8Aremplir grille de taille non valide.
     */
    private char[][] grille7x8Aremplir = { { '@', '6', '@', '@', '4', '5', '3', '7' },
            { '@', '@', '5', '6', '7', '3', '4', '2' }, { '@', '@', '4', '@', '@', '@', '@', '@' },
            { '5', '@', '@', '7', '@', '2', '@', '@' }, { '6', '@', '9', '@', '@', '@', '2', '5' },
            { '8', '@', '7', '@', '@', '9', '@', '@' }, { '@', '5', '@', '@', '2', '@', '1', '@' } };
    /**
     ...
     * grille9x9TestRemplie grille de test 9x9 remplie.
     */
    private GrilleImpl grille16x16TestRemplie = new GrilleImpl(grille16x16Remplie);
    ...
    public final void testSetValue2() {
        final int col = 15;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.setValue(1, col, '8'));
    }
    ...
    public final void testSetValue3() {
        final int ligne = 34;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.setValue(ligne, 0, '8'));
    }

    /**
     * methode qui teste SetValue . lorque le caractere donné est un caractère non
    ...
    public final void testSetValue5() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.setValue(1, 2, 'z'));
    }
    ...
    /**
     * methode qui teste la fonction GetValue lorsque la colonne est hors borne.
     * grille 9X9
     */
    @Test
    public final void testGetValue3() {
        final int col = 15;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.getValue(col, 1));
    }

    /**
     * methode qui teste la fonction GetValue lorsque la ligne est hors borne.
     * grille 9X9
     */
    @Test
    public final void testGetValue4() {
        final int ligne = 34;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.getValue(0, ligne));
    }
    ...
    public final void testGetValue5() {
        final int col = 19;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.getValue(col, 1));
    }
    ...
    public final void testGetValue6() {
        final int ligne = 34;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.getValue(0, ligne));
    }

    /**
     * methode qui teste Complete() le cas où la grille 9X9 n'est pas complète.
     */
    @Test
    ...
    /**
     * methode qui teste Complete() le cas où la grille 9X9 est complète.
     */
    @Test
    ...
    /**
     * methode qui teste Complete() le cas où la grille 16X16 n'est pas complète.
     */
    @Test
    ...
    /**
     * methode qui teste Complete() le cas où la grille 16X16 est complète.
     */
    @Test
    ...
    /**
     * methode qui teste verifGetValue() le cas où une coordonnée de la grille 9X9
     * est hors borne.
     */
    @Test
    ...
    /**
     * methode qui teste verifGetValue() le cas où une coordonnée de la grille 16X16
     * est hors borne.
     */
    @Test
    ...
    /**
     * methode qui teste lignePossible(). pour voir si une valeur existe dans la
     * ligne grille 9X9
     */
    @Test
    ...
    /**
     * methode qui teste lignePossible(). pour voir si une valeur n'existe pas dans
     * la ligne grille 9X9
     */
    @Test
    ...
    /**
     * methode qui teste lignePossible(). pour voir si une valeur donnée est
    ...
    /**
     * methode qui teste colonnePossible(). pour voir si une valeur n'existe pas
    ...
    /**
     * methode qui teste colonnePossible(). pour voir si une valeur existe dans la
     * colonne grille 9X9
     */
    @Test
    ...
    /**
     * methode qui teste colonnePossible(). pour voir si une valeur donnée est
    ...
    /**
     * methode qui teste carrePossible(). pour voir si une valeur donnée est
    ...
    /**
     * methode qui teste carrePossible(). pour voir si un caractère est impossible
    ...
    /**
     * methode qui teste carrePossible(). pour voir si la ligne est hors borne
     * grille 9X9
     */
    @Test
    public final void testCarrePossible7() {
        final int ligne1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.possible(ligne1, 0, '2'));
    }
    ...
    public final void testCarrePossible8() {
        final int ligne1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.carrePossible(ligne1, 0, 'A'));
    }

    /**
     * methode qui teste carrePossible(). pour voir si la colonne est hors borne
     * grille 9X9
     */
    @Test
    public final void testCarrePossible9() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.carrePossible(0, col1, '2'));
    }
    ...
    public final void testCarrePossible10() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.carrePossible(0, col1, 'A'));
    }

    /**
     * methode qui teste Possible(). pour voir si une valeur est impossible, grille
     * 9X9
     */
    @Test
    ...
    /**
     * methode qui teste Possible(). pour voir si une valeur est possible grille 9X9
     */
    @Test
    ...
    /**
     * methode qui teste Possible() pour voir si le caractere est non autorise.
     * grille 9X9
     */
    @Test
    ...
    public final void testPossible6() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.possible(0, 0, 'z'));
    }

    /**
     * methode qui teste Possible() pour voir si la colonne est hors borne. grille
     * 9X9
     */
    @Test
    public final void testPossible7() {
        final int col1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.possible(0, col1, '9'));
    }
    ...
    public final void testPossible8() {
        final int col1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.possible(0, col1, '9'));
    }

    /**
     * methode qui teste Possible() pour voir si la ligne est hors borne. * grille
     * 9X9
     */
    @Test
    public final void testPossible9() {
        final int ligne1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.possible(ligne1, 0, '9'));
    }
    ...
    public final void testPossible10() {
        final int ligne1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.possible(ligne1, 0, '9'));
    }

    /**
     * methode qui teste Possible() pour voir si les ligne et colonne sont hors
     * bornes. grille 9X9
     */
    @Test
    public final void testPossible11() {
        final int ligne1 = 88;
        final int col1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille9x9Test.possible(ligne1, col1, '9'));
    }
    ...
    public final void testPossible12() {
        final int ligne1 = 88;
        final int col1 = 88;
        Assertions.assertThrows(IllegalArgumentException.class, () -> grille16x16Test.possible(ligne1, col1, '9'));
    }

    /**
     * methode qui teste Possible(). pour voir si une valeur est possible. grille
     * 9X9
     */
    @Test
    ...
    public final void testSolve9X9() {
        ...
        assertEquals(true, grille9x9Test.solve());
    ...
    public final void testSolve16X16() {
        GrilleImpl grille16x16Test = new GrilleImpl(grille16x16Aremplir1);
        GrilleImpl grille16x16TestRemplie = new GrilleImpl(grille16x16Remplie1);
        assertEquals(true, grille16x16Test.solve());
        assertEquals(true, grille16x16TestRemplie.solve());
        assertEquals(true, grille16x16TestRemplie.complete());
